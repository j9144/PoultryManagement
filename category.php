    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        ...
        <ul class="nav">
            <li class="dropdown menu-item">
              <!-- <?php 
            //   $sql=mysqli_query($con,"select SubCategory_Id,SubCategory_name  from tbl_subcategory where Category_Id='$cid'");
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="project/assets/images/banners/cat-banner-1.jpg" alt="" class="img-responsive">
			</div>
				...
				<div class="caption vertical-top text-left">
					<div class="big-text">
						<br />
					       ...
					       <?php $sql=mysqli_query($con,"select Category_name  from tbl_category where Category_Id='$cid'");
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=mysqli_query($con,"select * from tbl_products where Category_Id='$cid'");
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="project/assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['image']);?>" alt="" width="200" height="300"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
