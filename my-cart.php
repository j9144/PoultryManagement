...
// $reference = rand(100000000000,900000000000);
// $sq = "update `tbl_orders` set `Reference_Number` =  '$reference' where `Order_Id`='$orderid'";
...
// code for billing address updation
	if(isset($_POST['update']))
	{
		...
		// $trackid = $_POST['track_number'];
		$query=mysqli_query($con,"update tbl_users set billingAddress='$baddress',billingCity='$bcity',billingState='$bstate',billingPincode='$bpincode' where User_Id='".$_SESSION['userid']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($con,"update tbl_users set shippingAddress='$saddress',shippingCity='$scity',shippingState='$sstate',shippingPincode='$spincode' where User_Id='".$_SESSION['userid']."'");
		if($query)
		{
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="Homeindex.php" class="btn btn-upper btn-primary outer-left-xs">Continue Shopping</a>
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="product-details.php">
						    <img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['image'];?>" alt="" width="114" height="146">
						</a>
					</td>
...
$_SESSION['sid']=$pd;
						...
						<div class="row">
							...
							<div class="col-sm-8">
<?php $rt=mysqli_query($con,"select * from tbl_productreviews where Product_Id='$pd'");
...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rs"." ".$row['productShippingcharge']; ?>.00</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['productShippingcharge']); ?>.00</span></td>
				</tr>
...
<?php 
// $reference = rand(100000000000,900000000000);
// $sq = "update `tbl_orders` set `Reference_Number` =  '$reference' where User_Id='".$_SESSION['userid']."'";
// $re = mysqli_query($con,$sq);
// echo $reference;
?>
<!-- <input type = "hidden" name = "track_number" value = "<?php echo $reference;?>" > -->
