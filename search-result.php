...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="project/assets/images/banners/cat-banner-3.jpg" alt="" class="img-responsive">
			</div>
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=mysqli_query($con,"select * from tbl_products where name like '$find'");
			...
			<div class="product-price">	
				...
				<div class="action">
					...
					<?php if($row['productAvailability']=='In Stock'){?>
							...
							<a href="category.php?page=product&action=add&id=<?php echo $row['Category_Id']; ?>">
