...
$query=mysqli_query($con,"SELECT * FROM tbl_users WHERE Email='$email' and Phone_No='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="forgot-password.php";
mysqli_query($con,"update tbl_users set Password='$password' WHERE Email='$email' and Phone_No='$contact' ");
...
<html lang="en">
	<head>
	    ...
	    <title>Madayikkal Poultries| Forgot Password</title>
