...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php 
$ret = mysqli_query($con,"SELECT `PostingDate`,`Status`,`Remark` FROM tbl_ordertrackhistory WHERE `Order_Id`='$oid'");
...
while($row=mysqli_fetch_array($ret))
   ...
   <?php  }
$st='Delivered';
   $rt = mysqli_query($con,"SELECT OrderStatus FROM tbl_orders WHERE Order_Id='$oid'");
