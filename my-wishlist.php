...
if(isset($_GET['del']))
{
$query=mysqli_query($con,"delete from tbl_wishlist where Wishlist_Id='$wid'");
}
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
<?php
$ret=mysqli_query($con,"select tbl_products.name as pname,tbl_products.id as proid,tbl_products.image as pimage,tbl_products.productPrice as pprice,tbl_wishlist.Product_Id as pid,tbl_wishlist.Wishlist_Id as wid from tbl_wishlist join tbl_products on tbl_products.id=tbl_wishlist.Product_Id where tbl_wishlist.User_Id='".$_SESSION['userid']."'");
