...
#cont
{
  ...
  <body>
    ...
    <div class="" style="text-align: center; padding-left:-50px; color:black">
      <h1 style="color: black ;padding-top: 30px;margin-top:-50px ">BIRD STOCK</h1>
 ...
 $sql1 = "select tbl_breed.Breed_Id,tbl_breed.Breed_Type,tbl_addbird.Bird_Id,tbl_addbird.BirdCount,tbl_addbird.Breed,tbl_addbird.BirdDate from tbl_breed join tbl_addbird on tbl_breed.Breed_Id = tbl_addbird.Breed where BirdCount>0 ";
...
else
{
  ...
  echo"<tr >";
  echo"<td>",$row['BirdCount'],"</td><td>&nbsp;", $row['Breed_Type'],"</td>";
  
     echo "<td>&nbsp;",$row['BirdDate'],"</td>";
     $id=$row['Bird_Id'];
  ?>
