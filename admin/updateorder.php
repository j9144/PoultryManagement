...
$query=mysqli_query($con,"insert into tbl_ordertrackhistory(Order_Id,Status,Remark) values('$oid','$status','$remark')");
$sql=mysqli_query($con,"update tbl_orders set OrderStatus='$status' where Order_Id='$oid'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php 
$ret = mysqli_query($con,"SELECT * FROM tbl_ordertrackhistory WHERE Order_Id='$oid'");
   ...
   <?php 
$st='Delivered';
   $rt = mysqli_query($con,"SELECT * FROM tbl_orders WHERE Order_Id='$oid'");
