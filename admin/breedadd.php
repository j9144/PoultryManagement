<?php
          ...
          if (isset($_POST['sub'])){
            ...
            $item = $_POST['breed_type'];
           
            $sql = "insert into tbl_breed(Breed_Type) values('$item')";
...
<?php include('include/header.php');?>
      ...
      <div class="container">
         <div style = "margin-left:-30px">
            ...
            <div class="span9">
               <div class="content">
                  <div class="module" style = "margin-top:-660;margin-left:300px;width:80%">
                        <div class="module-head">
                            <h3>Add Breed</h3>
                        </div>
              <form method="post" enctype="multipart/form-data">
              <label style = "margin-left:20px" >Breed Type</label>  
                          <input type="text" name="breed_type" class="form-control" style = "margin-left:20px; width :80%" />  
                          <br />  
