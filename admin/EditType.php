...
$id = $_GET['id'];
$sql = mysqli_query($con,"select * from tbl_type where Type_Id='$id'");
...
if(isset($_POST["sub"])){
   ...
   $edit =  "update `tbl_type` set Type ='$name ' where Type_Id='$id'";
...
<?php include('include/header.php');?>
      ...
      <!-- <div class="panel panel-default" >
        <div class="panel-heading" style = "text-align : center">Staff Designation</div>
        <div class="panel-body" >
        <div class="row"> -->
              <form method="post" enctype="multipart/form-data">
              <div class="col-sm-3">
              <label style = "margin-left:10px" >Staff Name</label>  
                          <input type="text" name="type_name"  value ="<?php echo $row['Type'];?> "class="form-control" style = "margin-left:10px  width: 80%;" />  
                          <br />  
                ...
                <table id="product_table" class="table table-bordered" style = "max-width:20%; margin-left:30px;margin-top:25px">
                    <thead > 
                    <tr>
