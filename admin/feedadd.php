<?php
          ...
          if (isset($_POST['sub'])){
            ...
            $item = $_POST['feed_type'];
           
            $sql = "insert into tbl_feed(Feed_Type) values('$item')";
         ...
         <div style = "margin-left:-30px">
            ...
            <div class="span9">
              ...
              <label style = "margin-left:10px" >Feed Type</label>  
                          <input type="text" name="feed_type" class="form-control" style = "margin-left:10px;width :80%" />  
                          <br />  
                          <input type="submit" name="sub" class="btn btn-info" value="Submit"  style = "margin-left:10px"/>  
