      ...
      <div class="wrapper">
         <div class="container">
            <div style = "margin-left:-30px">
               <?php include('include/sidebar.php');?>	</div>			
               <div class="span9">
                  <div class="content">
                     <div class="module" style = "margin-top:-660px;margin-left:300px;width:100%">
                        <div class="module-head">
                           <h3>Add Staff</h3>
                        </div>
                        <br>
                        <form method="post" enctype="multipart/form-data">
                           <div class="col-sm-3" style = "margin-left:250px;margin-top:30px;width:50%">
                              ...
                              <br>
                              <input type="submit" id="insert" class="btn btn-success"  name="submit"> <br>
                           </div>
                           <br>
                        </form>
                     <!-- </div> -->
