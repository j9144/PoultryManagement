...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($con,"select max(id) as pid from tbl_products");
    $results=mysqli_fetch_array($query);
    $productid=$results['pid']+1;
...
//    move_uploaded_file($_FILES["productimage3"]["tmp_name"],"productimages/$productid/".$_FILES["productimage3"]["name"]);
   ...
   $sql = "INSERT INTO `tbl_products`(`Category_Id`,`name`,`productDescription`,`code`, `image`,`productPriceBeforeDiscount`, `productPrice`,`productShippingcharge`,`quantity`,`productAvailability`) VALUES ('$category','$name','$productdescription','$code','$productimage','$productpricebd','$productprice','$productscharge','$qty','$productavailability')";
...
<?php include('include/header.php');?>
      ...
      <div class="container">
         <div style = "margin-left:-30px">
            ...
            <div class="span9">
               <div class="content">
                  <div class="module" style = "margin-top:-660px;margin-left:300px;width:80%">
              ...
              <form method="post" name = "Insert" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-3" style = "margin-left:50px">
                   ...
                   <input type="text" name="product_code" class="form-control"/> 
                    ...
                    <div class="controls">
                    <input type="file" name="productimage" id="productimage" accept="image/*"   class="form-control" value="" class="span8 tip"  onchange = "preview_Image(event)" required>
                    <img id = "imageDis" src="http://placehold.it/180" alt="your image"  width = "180 px" /> <br>
                    </div>
                    </div>
            ...
            <div class="col-sm-9">
                ...
                <table id="product_table" class="table table-bordered">
                    ...
                    <?php
                        include ('DbConnect.php');
                        $result = mysqli_query($con,"select tbl_category.Category_name,tbl_products.name,tbl_products.productPrice,tbl_products.id from tbl_category JOIN tbl_products
                        ...
                        while($row = mysqli_fetch_array($result)){?>
                         ...
                         <td>
                            <a href="EditPdt.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary btn-xs"><i class = "fas fa-edit"> </i> Edit</a>
                         </td>
                ...
                <td>
                    ...
                    if($row['Status']=="1") 
                        ...
                        echo 
                        "<a href=deactivate.php?id=".$row['id']." class='btn red ' >Deactivate</a>";
                          else 
                        echo 
