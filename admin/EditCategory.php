...
$id = $_GET['id'];
$sql = mysqli_query($con,"select * from tbl_category where Category_Id='$id'");
...
if(isset($_POST["sub"])){
   ...
   $edit =  "update `tbl_category` set Category_name ='$name ' where Category_Id='$id'";
      ...
      <div class="panel panel-default">
        ...
        <div class="row">
              ...
              <label style = "margin-left:10px" >Category Name</label>  
                          <input type="text" name="category_name"  value ="<?php echo $row['Category_name'];?> "class="form-control" style = "margin-left:10px  width: 80%;" />  
                          <br />  
