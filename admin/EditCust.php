...
$id = $_GET['id'];
$sql = mysqli_query($con,"select * from tbl_register where Reg_ID = '$id' ");
...
if(isset($_POST["sub"])){
   ...
   $edit =  "update `tbl_register` set Name ='$name ', Address = '$address',Email = '$email',Phone_No = '$phnno' where Reg_ID = '$id' and Status = '0'";
...
<center>
        ...
        <div class="row">
            ...
            <input type = "text" name = "phnno" value ="<?php echo $row['Phone_No'];?> " class="form-control"/> <br>
