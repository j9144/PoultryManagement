...
<body>
  ...
  <div  id="mySidebar" class="sidebar">
    ...
    <div class="dropdown">
      <button class="dropdown-btn"><i class="fa fa-store"> </i> Products
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-container">
      ...
      <!-- <a href="Sub_Category.php">Sub_Categories</a> -->
    </div>
  </div>
  ...
  <div class="dropdown">
      <button class="dropdown-btn"><i class="fa fa-cog"> </i> Farm Settings
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-container">
    ...
    <a href = "Logout.php"> <i class = "fas fa-sign-out"> </i> Logout </a> <br>
  </div>
