<?php
          ...
          if (isset($_POST['sub'])){
            ...
            $item = $_POST['category_name'];
           
            $sql = "insert into tbl_category(Category_name) values('$item')";
         ...
         <div style = "margin-left:-30px">
            ...
            <div class="span9">
              ...
              <label style = "margin-left:20px" >Category Name</label>  
                          <input type="text" name="category_name" class="form-control" style = "margin-left:20px; width:50%" />  
                          <br />  
            ...
            <div class="col-sm-9">
                <div class="table-responsive" style = "margin-top:10px;margin-left:20px;" >
                <table id="product_table" class="table table-bordered">
                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_array($result)){?>
                         ...
                         <td>
                            <a href="EditCategory.php?id=<?php echo $row["Category_Id"]; ?>" class="btn btn-primary btn-xs"><i class = "fas fa-edit"> </i> Edit</a>
                            <a href="DeleteCategory.php?id=<?php echo $row["Category_Id"]; ?>" class="btn btn-danger btn-xs"><i class = "fas fa-trash"> </i>Delete</a>
                         </td>
