...
div.main {
  ...
  <body>
    ...
    <div class="" style="text-align: center; padding-left:50px; color:black">
      <h1 style="color: black;padding-top: 30px;margin-top:-130px ">FEED STOCK</h1>
  ...
  include("../DbConnect.php");
    //$login=$_SESSION['id'];
    // echo $login;
  $sql1="select * from `tbl_feedsupplier` where Feed_Quantity>0 ";
  $res1=mysqli_query($con,$sql1);
  $res1=mysqli_query($con,$sql1);
  $n=mysqli_num_rows($res1);
if($n==0)
{
  echo "<div class='container' id='cont'><h1>Your Stock is empty Please Add Supplies</h1></div>";
}
else
{
  ...
  echo"<tr >";
  $type_id=$row['SFeed_Type'];
  $sql="select * from `tbl_feed` where Feed_Id=$type_id";
  $res=mysqli_query($con,$sql);
  while($row1=mysqli_fetch_array($res))
  {
    echo "<td>&nbsp;",$row1['Feed_Type'],"</td>";
  }
  echo"<td>",$row['Feed_Quantity'],"</td><td>&nbsp;",$row['Feed_EDate'],"</td>";
  
     echo "<td>&nbsp;",$row['Feed_Price'],"</td>";
     // $id=$row['hbird_id']
  ?>
