  ...
  <div class="Navbar">
    ...
    <nav class="Navbar__Items Navbar__Items--right">
      ...
      <h3 style = "color:#white;">Welcome <?php echo $_SESSION['Email']; ?>.</h3>
       <div class="dropdown">
          <button class="dropdown-btn"> <i class="fa fa-user"> </i>  Supplier
...
<?php
  ...
  <div  id="mySidebar" class="sidebar">
    ...
    <a href="supplier_addfeed.php" class="button button1">Add Feeds</a>
           <a href="supplier_vieworder.php" class="button button1">View Orders</a>
           <a href="supplier_orderrequests.php" class="button button1">Order Requsts</a>
           <a href="supplier_viewstock.php" class="button button1">View Stock</a>
